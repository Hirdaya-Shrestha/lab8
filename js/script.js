...
// active nav link
document.querySelectorAll(".nav-links a").forEach((a) => {
  if (a.href === location.href || a.href === location.href + "/")
    a.classList.add("active");
  else if (
    location.pathname.includes(a.getAttribute("href") || "") &&
    a.getAttribute("href") !== "/"
  )
    a.classList.add("active");
  else if (
    location.href.endsWith("/lab8/portfolio/") &&
    a.getAttribute("href") === "/lab8/portfolio/"
  )
    a.classList.add("active");
});
